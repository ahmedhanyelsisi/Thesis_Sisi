...
colIa = [0.0000 0.6200 0.4510];   % current phase A - bluish green #009E73
colIb = [0.5450 0.0000 0.5450];   % current phase B - dark magenta #8B008B
colIc = [0.8500 0.0000 0.0000];   % current phase C - red   #D55E00
...
hIa = plot(ax1, t_c_dec*1e3, I_filt(:,1)*scale, '-', 'Color', colIa, 'LineWidth', 2.2);
hIb = plot(ax1, t_c_dec*1e3, I_filt(:,2)*scale, '-', 'Color', colIb, 'LineWidth', 2.2);
hIc = plot(ax1, t_c_dec*1e3, I_filt(:,3)*scale, '-', 'Color', colIc, 'LineWidth', 2.2);
